function bring_cup_with_ur3_trajectory()
    ...
    T0_6_p3 = util_get_end_joint_matric(0,0,35,      0.2,-0.1,0,      T6_c);
    T0_6_p4 = util_get_end_joint_matric(0,-60,0,     0.2,-0.1,0.3,    T6_c);
%     T0_6_p5 = util_get_end_joint_matric(0,-60,0,     0.3,0,0.4,    T6_c);
...
%     DH_points(:,:,5)=T0_6_p5;
    ...
    if use_cartesian_plan
        ...
        for i=1:size(joint_q,1)
            ...
            T = ur3_forward_kinematics(6,joint_q(i,:));
            q(:,:,i)=T;
        end
