function [valid,q,qd,qdd] = get_joints_trajectory_plan(cartesian_DH,target_velocity,tstep,tacc)
 addpath(genpath('ur3_utils'),genpath('ur3_robot'),genpath('ur3_inverse_kinematics'),genpath('ur3_forward_kinematics'),genpath('ur3__trajectory_plan'),genpath('ur3_plot'))
