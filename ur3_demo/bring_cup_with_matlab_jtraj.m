function bring_cup_with_matlab_jtraj()
    addpath(genpath('ur3_utils'),genpath('ur3_robot'),genpath('ur3_inverse_kinematics'),genpath('ur3_forward_kinematics'),genpath('matlab_trajectory_plan'),genpath('ur3_plot'))
    ...
    T0_6_p1 = util_get_end_joint_matric(0,0,35,  -0.2,-0.1,0.3,T6_c);
    T0_6_p2 = util_get_end_joint_matric(0,0,35,  -0.2,-0.1,0, T6_c);
    T0_6_p3 = util_get_end_joint_matric(0,-60,0,     0.2,-0.1,0, T6_c);
    T0_6_pf = util_get_end_joint_matric(0,-60,0,     0.2,-0.1,0.4,T6_c);
    
    [valid,result_list] = ur3_inverse_kinematics(T0_6_p1)
